...
function cfturnstile_force_render($unique_id = '') {
	...
	document.addEventListener("DOMContentLoaded", function() {
		var e = document.getElementById("cf-turnstile<?php echo esc_html($unique_id); ?>");
		if (e) { turnstile.remove("#cf-turnstile<?php echo esc_html($unique_id); ?>"); }
		turnstile.render("#cf-turnstile<?php echo esc_html($unique_id); ?>", {sitekey: "<?php echo esc_html($key); ?>"});
	});
	</script>
	<?php
	}
